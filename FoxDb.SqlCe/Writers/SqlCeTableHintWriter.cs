...
namespace FoxDb
{
    ...
    {
        public SqlCeTableHintWriter(IFragmentBuilder parent, IQueryGraphBuilder graph, IDatabase database, IQueryGraphVisitor visitor, ICollection<IDatabaseQueryParameter> parameters)
        ...
        public override FragmentType FragmentType
        {
            get
            {
                return SqlCeQueryFragment.TableHint;
            }
        }
