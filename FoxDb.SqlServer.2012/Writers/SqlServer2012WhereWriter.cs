...
namespace FoxDb
{
    public class SqlServer2012WhereWriter : SqlWhereWriter
    {
        public SqlServer2012WhereWriter(IFragmentBuilder parent, IQueryGraphBuilder graph, IDatabase database, IQueryGraphVisitor visitor, ICollection<IDatabaseQueryParameter> parameters)
